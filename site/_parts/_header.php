...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark" style="color:white">
  ...
  <div
    ...
    style="
      background-image: url('images/nee.jpg');
    ...
    <div class="mask" style="background-color: rgba(0, 0, 0, 0.6); margin-top: 80px; ">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white">
          <h1 class="mb-1">Atividade Interdisciplinar</h1>
          <h2 class="mb-1">Tecnico em Infomática | Mª Clara - 3ª ano 'A' </h2>
